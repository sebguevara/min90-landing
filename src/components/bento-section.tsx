...
const items: Item[] = [
  {
    ...
    points: ["📊 Estadísticas de partidos", "📈 Predicciones y tendencias", "⏱️ Resumen en minutos"],
  },
  {
    title: "Comunidad activa",
    description: "Grupo privado para debatir y aprender.",
    points: ["💬 Debates en vivo", "🗳️ Encuestas y opiniones", "🤝 Networking deportivo"],
  },
  {
...
const BentoCard = ({ title, description, points }: Item) => (
  <div className="group relative rounded-2xl p-[1px] bg-gradient-to-br from-white/20 via-white/5 to-transparent">
    <Card className="h-full rounded-2xl bg-background/60 backdrop-blur-md border-white/15 transition
